This program answers whether a number is prime or not. It is possible to enter the number via the command line or just call the program and wait for it to request it.
